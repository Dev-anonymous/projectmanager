                                ...
                                <div class="m-2">
                                    <div class="">
                                        <a class="btn btn-danger-light btn-border-down btn-sm btn-wave waves-effect waves-light"
                                            href="{{ route('agent.transactions-new') }}">Nouvelle transaction
                                        </a>
                                        {{-- <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-text text-muted"> <i
                                                        class="ri-calendar-line"></i> </div>
                                                <input readonly type="text" class="form-control" id="daterange"
                                                    placeholder="Date">
                                            </div>
                                        </div> --}}
                                    </div>
        ...
        $(document).ready(function() {
            ...
            function getdata() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        var txt = `<span class="fs-16 fw-semibold">${data.solde_cdf}</span>`;
                        $('[soldecdf]').html(txt);
                        var txt2 = `<span class="fs-16 fw-semibold">${data.solde_usd}</span>`;
                        $('[soldeusd]').html(txt2);
            ...
            function formatState(state) {
                ...
                var $state = $(
                    ...
                    '.jpg" class="img-flag" > ' + state.text + '</span>'
                );

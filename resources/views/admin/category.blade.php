...
<head>
    ...
    <title> Catégorie | {{ config('app.name') }} </title>
    <x-css-file />
</head>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Catégorie</h1>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="card-title">Catégorie des Comptes</div>
            ...
            <div class="modal-dialog  text-center" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Nouvelle catégorie </h6><button aria-label="Close" class="btn-close"
                    ...
                    <form action="#" id="f-add">
                        <div class="modal-body text-start">
                            ...
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">Catégorie</label>
                                <input required type="text" name="categorie" class="form-control form-control-sm"
                                    id="signin-username" placeholder="Categorie">
                            </div>
                            <div class="mt-2">
                                <div id="rep"></div>
                            </div>
